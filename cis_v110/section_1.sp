...
benchmark "cis_v110_1" {
  title         = "1 Identity and Access Management (IAM)"
  ...
  children = [
    ...
    control.cis_v110_1_5,
    control.cis_v110_1_6,
    ...
    control.cis_v110_1_13,
    control.cis_v110_1_14,
    control.cis_v110_1_15,
    control.cis_v110_1_16,
    control.cis_v110_1_17,
    control.cis_v110_1_18,
    control.cis_v110_1_19,
  ]
...
control "cis_v110_1_5" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_5.md")
...
control "cis_v110_1_6" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_6.md")
  query         = query.manual_control
...
control "cis_v110_1_13" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_13.md")
...
control "cis_v110_1_14" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_14.md")
  query         = query.manual_control
...
control "cis_v110_1_15" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_15.md")
  query         = query.manual_control
...
control "cis_v110_1_16" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_16.md")
...
control "cis_v110_1_17" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_17.md")
  query         = query.manual_control
...
control "cis_v110_1_18" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_18.md")
  query         = query.manual_control
...
control "cis_v110_1_19" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_1_19.md")
  query         = query.manual_control
