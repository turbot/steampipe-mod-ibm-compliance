locals {
  cis_v110_6_common_tags = merge(local.cis_v110_common_tags, {
    cis_section_id = "6"
  })
}

locals {
  cis_v110_6_1_common_tags = merge(local.cis_v110_6_common_tags, {
    cis_section_id = "6.1"
  })
  cis_v110_6_2_common_tags = merge(local.cis_v110_6_common_tags, {
    cis_section_id = "6.2"
  })
}
...
benchmark "cis_v110_6" {
  title         = "6 Networking"
  documentation = file("./cis_v110/docs/cis_v110_6.md")
  children = [
    benchmark.cis_v110_6_1,
    benchmark.cis_v110_6_2
  ]

  tags = merge(local.cis_v110_6_common_tags, {
    type = "Benchmark"
  })
}
...
benchmark "cis_v110_6_1" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6_1.md")
  children = [
    control.cis_v110_6_1_1,
    control.cis_v110_6_1_2,
    control.cis_v110_6_1_3
  ]

  tags = merge(local.cis_v110_6_1_common_tags, {
    service = "IBM/CIS"
    type    = "Benchmark"
  })
}
...
benchmark "cis_v110_6_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6.md")
  children = [
    control.cis_v110_6_2_1,
    control.cis_v110_6_2_2,
    control.cis_v110_6_2_3,
    control.cis_v110_6_2_4,
    control.cis_v110_6_2_5
  ]

  tags = merge(local.cis_v110_6_2_common_tags, {
    service = "IBM/VPC"
    type    = "Benchmark"
  })
}
...
control "cis_v110_6_2_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6_2_2.md")
...
control "cis_v110_6_2_3" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6_2_3.md")
...
control "cis_v110_6_2_4" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6_2_4.md")
...
control "cis_v110_6_2_5" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_6_2_5.md")
