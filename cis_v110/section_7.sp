locals {
  cis_v110_7_common_tags = merge(local.cis_v110_common_tags, {
    cis_section_id = "7"
  })
}

locals {
  cis_v110_7_1_common_tags = merge(local.cis_v110_7_common_tags, {
    cis_section_id = "7.1"
  })
  cis_v110_7_2_common_tags = merge(local.cis_v110_7_common_tags, {
    cis_section_id = "7.2"
  })
}

locals {
  cis_v110_7_1_1_common_tags = merge(local.cis_v110_7_1_common_tags, {
...
benchmark "cis_v110_7" {
  title         = "7 Containers"
  documentation = file("./cis_v110/docs/cis_v110_7.md")
  children = [
    benchmark.cis_v110_7_1,
    benchmark.cis_v110_7_2,
  ]

  tags = merge(local.cis_v110_7_common_tags, {
    type = "Benchmark"
  })
}

benchmark "cis_v110_7_1" {
  title         = "7.1 IBM Cloud Kubernetes Service"
  documentation = file("./cis_v110/docs/cis_v110_7_1.md")
  children = [
    benchmark.cis_v110_7_1_1,
    control.cis_v110_7_1_2,
    control.cis_v110_7_1_3,
    control.cis_v110_7_1_4,
    control.cis_v110_7_1_5,
    control.cis_v110_7_1_6,
    control.cis_v110_7_1_7
  ]

  tags = merge(local.cis_v110_7_1_common_tags, {
    type = "Benchmark"
  })
}
...
benchmark "cis_v110_7_1_1" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_1.md")
  children = [
    control.cis_v110_7_1_1_1,
    control.cis_v110_7_1_1_2
  ]

  tags = merge(local.cis_v110_7_1_1_common_tags, {
    service = "IBM/KMS"
    type    = "Benchmark"
  })
}
...
control "cis_v110_7_1_1_1" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_1_1.md")
...
control "cis_v110_7_1_1_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_1_2.md")
  query         = query.manual_control
...
control "cis_v110_7_1_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_2.md")
  query         = query.manual_control
...
control "cis_v110_7_1_3" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_3.md")
  query         = query.manual_control
...
control "cis_v110_7_1_4" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_4.md")
  query         = query.manual_control
...
control "cis_v110_7_1_5" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_5.md")
  query         = query.manual_control
...
control "cis_v110_7_1_6" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_6.md")
  query         = query.manual_control
...
control "cis_v110_7_1_7" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_1_7.md")
  query         = query.manual_control
...
benchmark "cis_v110_7_2" {
  ...
  children = [
    control.cis_v110_7_2_1
  ]

  tags = merge(local.cis_v110_7_2_common_tags, {
    service = "IBM/Containers"
    type    = "Benchmark"
  })
}
...
control "cis_v110_7_2_1" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_7_2_1.md")
  query         = query.manual_control
