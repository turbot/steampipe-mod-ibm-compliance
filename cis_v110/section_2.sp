...
locals {
  cis_v110_2_1_common_tags = merge(local.cis_v110_2_common_tags, {
    cis_section_id = "2.1"
  })
  cis_v110_2_2_common_tags = merge(local.cis_v110_2_common_tags, {
    cis_section_id = "2.2"
  })
}

locals {
  cis_v110_2_1_1_common_tags = merge(local.cis_v110_2_1_common_tags, {
    cis_section_id = "2.1.1"
  })
  cis_v110_2_2_1_common_tags = merge(local.cis_v110_2_2_common_tags, {
...
benchmark "cis_v110_2" {
  ...
  children = [
    benchmark.cis_v110_2_1,
    benchmark.cis_v110_2_2,
  ]
...
benchmark "cis_v110_2_1" {
  ...
  children = [
    benchmark.cis_v110_2_1_1,
    control.cis_v110_2_1_2,
    control.cis_v110_2_1_3,
    control.cis_v110_2_1_4,
    control.cis_v110_2_1_5,
  ]

  tags = merge(local.cis_v110_2_1_common_tags, {
    service = "IBM/Storage"
    type    = "Benchmark"
  })
}
...
benchmark "cis_v110_2_1_1" {
  ...
  children = [
    control.cis_v110_2_1_1_1,
    control.cis_v110_2_1_1_2,
    control.cis_v110_2_1_1_3,
  ]

  tags = merge(local.cis_v110_2_2_1_common_tags, {
    service = "IBM/Storage"
    type    = "Benchmark"
  })
}
...
control "cis_v110_2_1_1_1" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_1_1_1.md")
  query         = query.object_storage_bucket_with_cmk

  tags = merge(local.cis_v110_2_1_1_common_tags, {
    cis_item_id = "2.1.1.1"
    cis_level   = "1"
    cis_type    = "manual"
    service     = "IBM/Storage"
...
control "cis_v110_2_1_1_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_1_1_2.md")
...
control "cis_v110_2_1_1_3" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_1_1_3.md")
  query         = query.object_storage_bucket_with_key_protect_enabled
...
control "cis_v110_2_1_2" {
  ...
  description   = ""
  documentation = file("./cis_v110/docs/cis_v110_2_1_2.md")
...
control "cis_v110_2_1_3" {
  ...
  description   = ""
  documentation = file("./cis_v110/docs/cis_v110_2_1_3.md")
  query         = query.manual_control
...
control "cis_v110_2_1_4" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_1_4.md")
  query         = query.manual_control
...
control "cis_v110_2_1_5" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_1_5.md")
...
benchmark "cis_v110_2_2" {
  ...
  children = [
    benchmark.cis_v110_2_2_1,
    control.cis_v110_2_2_2,
    control.cis_v110_2_2_3,
    control.cis_v110_2_2_4,
  ]

  tags = merge(local.cis_v110_2_2_common_tags, {
...
benchmark "cis_v110_2_2_1" {
  ...
  children = [
    control.cis_v110_2_2_1_1,
    control.cis_v110_2_2_1_2,
    control.cis_v110_2_2_1_3,
  ]
...
control "cis_v110_2_2_1_2" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_2_1_2.md")
  query         = query.manual_control
...
control "cis_v110_2_2_1_3" {
  ...
  documentation = file("./cis_v110/docs/cis_v110_2_2_1_3.md")
  query         = query.manual_control
...
control "cis_v110_2_2_2" {
  ...
  description   = "By default, IBM Cloud Block Storage provides provider-managed encryption for all data. For enhanced security, customers can bring their own encryption keys and manage them through IBM Key Management Services – Key Protect or Hyper Protect Crypto Services (HPCS). Provider-managed encryption is turned on by default and cannot be turned off."
  documentation = file("./cis_v110/docs/cis_v110_2_2_2.md")
  query         = query.manual_control
...
control "cis_v110_2_2_3" {
  ...
  description   = "By default, IBM Cloud Block Storage provides provider-managed encryption for all data. For enhanced security, customers can bring their own encryption keys and manage them through IBM Key Management Services – Key Protect or Hyper Protect Crypto Services (HPCS). Provider-managed encryption is turned on by default and cannot be turned off."
  documentation = file("./cis_v110/docs/cis_v110_2_2_3.md")
  query         = query.manual_control
...
control "cis_v110_2_2_4" {
  ...
  description   = "By default, IBM Cloud Block Storage provides provider-managed encryption for all data. For enhanced security, customers can bring their own encryption keys and manage them through IBM Key Management Services – Key Protect or Hyper Protect Crypto Services (HPCS). Provider-managed encryption is turned on by default and cannot be turned off."
  documentation = file("./cis_v110/docs/cis_v110_2_2_4.md")
  query         = query.manual_control
